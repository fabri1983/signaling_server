...
keytool -genkeypair -alias rootca -dname "cn=Local Development" -validity 1095 -keyalg RSA -keysize 2048 -ext bc:c -keystore rootca.jks -keypass rootcapass -storepass rootcapass
