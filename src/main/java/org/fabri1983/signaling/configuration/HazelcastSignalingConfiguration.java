...
import org.fabri1983.signaling.util.NextRTCEventWrapperSerializerV1;
...
public class HazelcastSignalingConfiguration {
    ...
    public HazelcastInstance hazelCastInstance(ReliableTopicConfig hzcTopicConfig) {
    	...
    	SerializerConfig eventContextSc = setSerializerForEventContext();
	...
	private SerializerConfig setSerializerForEventContext() {
